                ...
                <section className="section-privacy">
                    ...
                    <div className="row">
                        ...
                        <div className="col-3-of-4">
                            ...
                            <p className="paragraph paragraph--privacy">
                                <ul>
                                    <li><b>To provide and maintain our Service</b>, including to monitor usage of our Service.</li>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3-of-4">
                            <h3 className="heading-tertiary heading-tertiary-privacy">Business Transactions</h3>
                            ...
                            <h3 className="heading-tertiary heading-tertiary-privacy">Law Enforcement</h3>
                            ...
                            <h3 className="heading-tertiary heading-tertiary-privacy">Other legal requirements</h3>
                            ...
                            <h3 className="heading-tertiary heading-tertiary-privacy">Security of Your Personal Data</h3>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3-of-4">
                            ...
                            <p className="paragraph">If you'd like to request more information under the California Shine the Light law, and if you are a California resident, You can contact Us using the contact information provided below.</p>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3-of-4">
                            <p className="paragraph">California Business and Professions Code section 22581 allow California residents under the age of 18 who are registered users of online sites, services or applications to request and obtain removal of content or information they have publicly posted.</p>
                            <p className="paragraph">To request removal of such data, and if you are a California resident, You can contact Us using the contact information provided below, and include the email address associated with Your account.</p>
                            <p className="paragraph">Be aware that Your request does not guarantee complete or comprehensive removal of content or information posted online and that the law may not permit or require removal in certain circumstances.</p>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3-of-4">
                            ...
                            <p className="paragraph paragraph--privacy">
                                <ul>
                                    <li>By visiting this page on our website: <a href="http://www.empire534.la/contact">http://www.empire534.la/contact</a></li>
                                </ul>
                            </p>
                        </div>
                    </div>
